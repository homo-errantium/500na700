...
function Header({ windowWidth, handleConnectPopup }) {
  ...
  return (
    <header className="header" id="header">
      <div
        className={`header__overlay ${isOverlay && 'header__overlay_active'}`}
      >
      ...
      >
        ...
        >
          <img
            ...
            alt={isClicked ? 'кнопка закрытия меню' : 'кнопка открытия меню'}
